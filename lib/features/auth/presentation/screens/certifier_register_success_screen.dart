...
class CertifierRegisterSuccessScreen extends StatefulWidget {
  const CertifierRegisterSuccessScreen({super.key});

  @override
  State<CertifierRegisterSuccessScreen> createState() =>
      _CertifierRegisterSuccessScreenState();
}

class _CertifierRegisterSuccessScreenState
    extends State<CertifierRegisterSuccessScreen>
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              // Ícono en círculo cyan — usamos workspace_premium para diferenciar de auditor
              Container(
                width: 40,
                height: 40,
                decoration: BoxDecoration(
                ...
                child: const Icon(Icons.workspace_premium_outlined, color: _secondaryColor, size: 20),
              ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              const Expanded(
                child: Text(
                  'Our institutional verification team is reviewing your Certification Entity credentials. This process typically takes 24–48 business hours. You will receive an email notification once your account is active.',
                  style: TextStyle(
                    fontFamily: 'Inter',
                    fontSize: 14,
                    color: _onSurfaceVariantColor,
